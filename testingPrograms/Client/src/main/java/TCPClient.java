...
class TCPClient {
    public static void main(String argv[]) throws Exception
    {
        ...
        //for(int i = 0; i < 2;i++) {
            ...
            System.out.println("FROM SERVER: " + httpGet("http://10.0.0.2:8080/api/contextaware/v1/location/clients/00:00:2a:01:00:0a", "test", "works"));
            System.out.println("FROM SERVER: " + httpGet("http://10.0.0.2:8080/api/contextaware/v1/location/clients", "test", "works"));
        System.out.println("FROM SERVER: " + httpGet("http://10.0.0.2:8080/api/contextaware/v1/location/clients/00:00:2a:01:00:0a", "test", "works"));
    }
